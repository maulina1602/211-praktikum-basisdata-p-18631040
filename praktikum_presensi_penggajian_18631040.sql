...
-- Dumping data for table praktikum_presensi_penggajian_18631040.bagian: ~3 rows (approximately)
DELETE FROM `bagian`;
...
-- Dumping data for table praktikum_presensi_penggajian_18631040.bagian_karyawan: ~6 rows (approximately)
...
-- Dumping data for table praktikum_presensi_penggajian_18631040.jabatan: ~5 rows (approximately)
DELETE FROM `jabatan`;
...
-- Dumping data for table praktikum_presensi_penggajian_18631040.jabatan_karyawan: ~17 rows (approximately)
...
-- Dumping data for table praktikum_presensi_penggajian_18631040.karyawan: ~8 rows (approximately)
...
-- Dumping data for table praktikum_presensi_penggajian_18631040.lokasi: ~3 rows (approximately)
DELETE FROM `lokasi`;
...
-- Dumping data for table praktikum_presensi_penggajian_18631040.penggajian: ~18 rows (approximately)
...
-- Dumping data for table praktikum_presensi_penggajian_18631040.pengguna: ~8 rows (approximately)
...
-- Dumping data for table praktikum_presensi_penggajian_18631040.presensi: ~552 rows (approximately)
